...
<div class="container">
    ...
    <h2><a class="text-dark" href="{{ route('profile.show', ['user' => $user->id]) }}">{{ $user->username }}</a> followers</h2>
        ...
        <div class="d-flex align-items-center my-4">
            ...
            <div class="col-8 p-0">
                <h3 class="d-inline-block">
                    <a class="no-a-styling d-block" href="{{ route('profile.show', ['user' => $follower->id]) }}">
                        {{ $follower->name }}
                    </a>
                    <a class="no-a-styling d-block" href="{{ route('profile.show', ['user' => $follower->id]) }}">
