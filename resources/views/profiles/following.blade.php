...
<div class="container">
    ...
    <h2><a class="text-dark" href="{{ route('profile.show', $user->id) }}">{{ $user->username }}</a> following</h2>
    ...
    @foreach($following as $current)
        <div class="d-flex align-items-center my-4">
            <div class="col-4">
                <a href="{{ route('profile.show', $current->id) }}">
            ...
            <div class="col-8 p-0">
                <h3 class="d-inline-block">
                    <a class="no-a-styling d-block" href="{{ route('profile.show', $current->id) }}">
                        {{ $current->name }}
                    </a>
                    <a class="no-a-styling d-block" href="{{ route('profile.show', $current->id) }}">
